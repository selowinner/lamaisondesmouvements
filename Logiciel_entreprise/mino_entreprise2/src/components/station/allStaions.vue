                ...
                <v-row>
                  ...
                  <v-col cols="12" md="12" lg="12">
                    <v-text-field
                      ...
                      v-model="editedItem.other_denomination"
                      ref="transport"
                      type="text"
                  ...
                  <v-col cols="12" md="12" lg="12">
                    <v-text-field
                      ...
                      ref="location"
                      type="text"
                      v-model="editedItem.matriculation"
                      value=""
                  ...
                  <v-col cols="12" md="12" lg="12">
                    <v-switch
                      v-model="editedItem.package_service_use"
    ...
    <div class="dataWrapper">
      ...
      >
        ...
        <template v-slot:[`item.city`]="{ item }">
          <v-icon dense color="#476866"> mdi-map-marker-radius </v-icon>
          <span style="color: mainGreenColor">{{ item.city }}</span>
        </template>
        <template v-slot:[`item.package_service_use`]="{ item }">
          <v-chip dark v-if="item.package_service_use == 1" color="#476866">
            <v-icon color="mainGreenColor" small>mdi-star-shooting</v-icon
            >Oui</v-chip
          >
          <v-chip dark v-if="item.package_service_use == 0" color="#c7dcd4">
            <v-icon color="mainGreenColor" small>mdi-window-close</v-icon
            >Non</v-chip
          >
        </template>
      </v-data-table>
...
export default {
  ...
  methods: {
    ...
    editItemConfirm() {
      Vue.prototype.$http
        .put("http://127.0.0.1:3333/station/update", this.editedItem)
        .then((response) => {
