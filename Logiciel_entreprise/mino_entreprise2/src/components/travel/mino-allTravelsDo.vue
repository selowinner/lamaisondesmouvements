            ...
            <div class="backBoad backBoad-1">
              <div class="travelResume">
                <div class="part">
                  ...
                  <p>
                    <span>{{ editedItem.place_price }} FCFA</span><br />prix
                    d'une place
                  </p>
                  <p>
                ...
                <div class="part">
                  <p>
                    <span>{{ editedItem.ticketsCancelledNumber }}</span
                    ><br />tickets annulés
                  </p>
                  <p>
                    <span>{{ editedItem.traveltotalGain }} FCFA</span><br />gain
                    total des ventes
                  </p>
                  <p>
                    <span>{{ editedItem.ticketsSoldNumber }}</span
                    ><br />tickets vendus
                  </p>
                  <p>
                    <span>{{ editedItem.allPlaceNotReserved }}</span
                    ><br />Places restantes
                  </p>
                </div>
              </div>
