...
export default {
  ...
  data: () => ({
    ...
    desserts: [
      {
        sernder: "MINO",
        objet: "scipit voluptatibus corrupti dlaudantium ...",
        date: "09:00",
        
      },
      {
        sernder: "CENTRALE",
        objet: "25-03-2021 scipit voluptatibus em laborum lalaborum...",
        date: "09:00",
       
      },
      {
        sernder: "VOUS",
        objet: " voluptatibus corrupti dolorlaudantium as...",
        date: "09:00",
        
      },
      {
        sernder: "MINO",
        objet: "scipit voluptatibus corrupti dolorem ludantium as...",
        date: "09:00",
        
      },
      {
        sernder: "VOUS",
        objet: "RE:: scipit voluptatibus cor laborum laudantium as...",
        date: "09:00",
